...
The **Send feedback** and Microsoft documentation buttons open pages in the default browser. Nothing is submitted unless the user chooses to submit it on that website. GitHub and Microsoft apply their own privacy terms to their sites.
